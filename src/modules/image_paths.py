...
def Load_ImagePath(Manager):
    m = 2.5
    # Benchmark Images.
    Manager.image_korok = Canvas_Create.Photo_Image(
        image_path="benchmark_korok.png",
        width=int(100 * m),
        height=int(40 * m),
    )

    Manager.image_Lookout = Canvas_Create.Photo_Image(
        image_path="benchmark_lookout.png",
        width=int(100 * m),
        height=int(40 * m),
    )

    Manager.image_Kakariko = Canvas_Create.Photo_Image(
        image_path="benchmark_kakariko.png",
        width=int(100 * m),
        height=int(40 * m),
    )

    Manager.image_GSI = Canvas_Create.Photo_Image(
        image_path="benchmark_great_sky_island.png",
        width=int(100 * m),
        height=int(40 * m),
    )

    Manager.image_Goron = Canvas_Create.Photo_Image(
        image_path="benchmark_goron.png",
        width=int(100 * m),
        height=int(40 * m),
    )

    Manager.image_Zora = Canvas_Create.Photo_Image(
        image_path="benchmark_zora.png",
        width=int(100 * m),
        height=int(40 * m),
    )

    Manager.image_Depths = Canvas_Create.Photo_Image(
        image_path="benchmark_depths.png",
        width=int(100 * m),
        height=int(40 * m),
    )

    Manager.default_benchmark = Canvas_Create.Photo_Image(
    ...
    # Benchmark Borders
    Manager.benchmark_border = Canvas_Create.Photo_Image(
        image_path="benchmark_border.png",
        width=int(1272 / m),
        height=int(130 / m),
    )

    Manager.bench_load_element = Canvas_Create.Photo_Image(
    ...
    # Benchmark Borders
    Manager.bench_load_element_active = Canvas_Create.Photo_Image(
    ...
    Manager.background_LegacyBG = Canvas_Create.Photo_Image(
    ...
    Manager.background_RyuBG = Canvas_Create.Photo_Image(
    ...
    # UI Elements/Buttons
    Manager.master_sword_element = Canvas_Create.Photo_Image(
        image_path="Master_Sword.png",
        width=155,
        height=88,
    )
    Manager.master_sword_element2 = Canvas_Create.Photo_Image(
    ...
    Manager.master_sword_element_active = Canvas_Create.Photo_Image(
        image_path="Master_Sword_active.png",
        width=int(155 * 1.0),
        height=int(88 * 1.0),
    )

    Manager.master_sword_element2_active = Canvas_Create.Photo_Image(
    ...
    Manager.hylian_element = Canvas_Create.Photo_Image(
        image_path="Hylian_Shield.png",
        width=int(72 * 1.2),
        height=int(114 * 1.2),
    )

    Manager.hylian_element_active = Canvas_Create.Photo_Image(
        image_path="Hylian_Shield_Active.png",
        width=int(72 * 1.2),
        height=int(114 * 1.2),
    )

    Manager.background_UI_element = Canvas_Create.Photo_Image(
        image_path="BG_Left_2.png",
        width=1200,
        height=600,
    )

    Manager.background_UI_Cheats = Canvas_Create.Photo_Image(
    ...
    Manager.background_UI = Canvas_Create.Photo_Image(
    ...
    Manager.background_UI3 = Canvas_Create.Photo_Image(
    ...
    Manager.background_image = Canvas_Create.Photo_Image(
        image_path=image_path, width=1200, height=600, blur=2
    )
    ...
    Manager.blurbackground = Canvas_Create.Photo_Image(
        image_path=image_path, width=1200, height=600, img_scale=2.0, blur=3
    )
