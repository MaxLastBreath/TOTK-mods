...
class CustomDialog(ttk.Toplevel):
    def __init__(self, parent, title, message, custom_yes = str, custom_no = str, yes_img_1 = None, yes_img_2=None, no_img_1= None, no_img_2= None, width = int, height = int):  # fmt: skip
